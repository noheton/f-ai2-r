...
| ⚠ Ready for your check, via DOI/URL | 22 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 17 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (22)
...
# ✓ Human-verified — no action required (17)
