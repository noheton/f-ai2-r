...
| 🗂 Internal artefacts | 11 | None required — in-repo files, inspectable in git history |
...
- Cited: not currently cited in the paper
- Vendored copy: `paper/sections/03-dilution.tex` (hash in graph)

## ⏳ `paper-preview-html` — unverified

**paper-preview-html**

- **No human action yet.** The AI has not content-checked this source; ask for a content check (and vendoring where the license allows) before spending your time on it.
- Cited: not currently cited in the paper
- Vendored copy: `paper-preview.html` (hash in graph)

# 🗂 Internal artefacts — in-repo evidence, no literature check (11)
