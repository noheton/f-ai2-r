...
| ⚠ Ready for your check, via DOI/URL | 26 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 13 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (26)
...
## ⚠ `oecd-ai-principles` — ai-confirmed
...
```sh
python3 scripts/provlog.py promote --id oecd-ai-principles --to human-confirmed --agent florian-krebs --note "..."
python3 scripts/provlog.py promote --id oecd-ai-principles --to human-confirmed --agent florian-krebs --refuse --note "..."
```
...
# ✓ Human-verified — no action required (13)
