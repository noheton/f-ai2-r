...
| ⚠ Ready for your check, via DOI/URL | 17 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 22 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (17)
...
# ✓ Human-verified — no action required (22)
