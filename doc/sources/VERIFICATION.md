...
| ⚠ Ready for your check, via DOI/URL | 19 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 20 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (19)
...
# ✓ Human-verified — no action required (20)
