...
| ⚠ Ready for your check, via DOI/URL | 24 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 15 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (24)
...
# ✓ Human-verified — no action required (15)
