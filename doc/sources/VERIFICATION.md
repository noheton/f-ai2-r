...
## ⏳ `06-meta-experiment-tex` — unverified
...
- Vendored copy: `paper/sections/06-meta-experiment.tex` (hash in graph)

## ⏳ `07-discussion-tex` — unverified

**07-discussion-tex**

- **No human action yet.** The AI has not content-checked this source; ask for a content check (and vendoring where the license allows) before spending your time on it.
- Vendored copy: `paper/sections/07-discussion.tex` (hash in graph)
...
- **No human action yet.** The AI has not content-checked this source; ask for a content check (and vendoring where the license allows) before spending your time on it.
- Vendored copy: `README.md` (hash in graph)
...
## ⏳ `provenance-ttl` — unverified

**provenance-ttl**

- **No human action yet.** The AI has not content-checked this source; ask for a content check (and vendoring where the license allows) before spending your time on it.
- Vendored copy: `provenance.ttl` (hash in graph)

## ⏳ `references-bib` — unverified

**references-bib**

- **No human action yet.** The AI has not content-checked this source; ask for a content check (and vendoring where the license allows) before spending your time on it.
- Vendored copy: `paper/references.bib` (hash in graph)
