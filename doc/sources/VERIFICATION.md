...
| ⚠ Ready for your check, via DOI/URL | 27 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 12 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (27)
...
# ✓ Human-verified — no action required (12)
