...
| ⚠ Ready for your check, via DOI/URL | 30 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 9 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (30)
...
# ✓ Human-verified — no action required (9)
