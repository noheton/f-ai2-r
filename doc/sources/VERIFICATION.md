...
| ⚠ Ready for your check, via DOI/URL | 16 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 23 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (16)
...
# ✓ Human-verified — no action required (23)
