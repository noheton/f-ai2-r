...
| 🗂 Internal artefacts | 13 | None required — in-repo files, inspectable in git history |
...
- Cited: not currently cited in the paper
- Vendored copy: `paper/sections/05-skill.tex` (hash in graph)

# 🗂 Internal artefacts — in-repo evidence, no literature check (13)
