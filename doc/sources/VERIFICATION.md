...
| ⚠ Ready for your check, via DOI/URL | 21 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 18 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (21)
...
# ✓ Human-verified — no action required (18)
