...
| ⚠ Ready for your check, via DOI/URL | 23 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 16 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (23)
...
# ✓ Human-verified — no action required (16)
