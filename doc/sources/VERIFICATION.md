...
| ⏳ Not yet ready | 1 | None yet — ask the agent to content-check or vendor first |
| 🗂 Internal artefacts | 18 | None required — in-repo files, inspectable in git history |
...
# ⏳ Not yet ready — AI-side work pending, no human action yet (1)

## ⏳ `build_paper_preview-py` — unverified
...
- Cited: not currently cited in the paper
- Vendored copy: `scripts/build_paper_preview.py` (hash in graph)

# 🗂 Internal artefacts — in-repo evidence, no literature check (18)
