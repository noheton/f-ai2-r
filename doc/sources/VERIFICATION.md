...
| ⚠ Ready for your check, via DOI/URL | 28 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 11 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (28)
...
# ✓ Human-verified — no action required (11)
