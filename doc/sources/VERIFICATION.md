...
| ⚠ Ready for your check, via DOI/URL | 13 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 26 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (13)
...
# ✓ Human-verified — no action required (26)
