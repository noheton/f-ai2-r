...
| ⚠ Ready for your check, via DOI/URL | 31 | Follow the access link, check, grant or refuse |
...
| ✓ Human-verified | 6 | Done (optionally deepen to `human-read`) |
...
# ⚠ Awaiting your check — obtain via link (31)
...
## ⚠ `unhide-helmholtz-kg` — ai-confirmed
...
```sh
python3 scripts/provlog.py promote --id unhide-helmholtz-kg --to human-confirmed --agent florian-krebs --note "..."
python3 scripts/provlog.py promote --id unhide-helmholtz-kg --to human-confirmed --agent florian-krebs --refuse --note "..."
```
...
# ✓ Human-verified — no action required (6)
