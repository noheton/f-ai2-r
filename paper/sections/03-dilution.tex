...
has learned to imitate all three. Fabricated and erroneous citations
propagate through reference
lists~\cite{fabricated-citations2023, ai-hallucination2023}, and
models trained on the polluted pool degrade
further~\cite{model-collapse2024}, so dilution compounds. The
