...
\textbf{Cost, and a visible gap.} The method's overhead in this
...
so Table~\ref{tab:telemetry} carries no such figures. The gap is
itself a finding. Provider-side usage reporting is the missing
infrastructure for honest cost accounting in AI-assisted work.
